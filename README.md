...
### 📊 Получение ценовой информации
- **Розничная цена с НДС** 
- **Розничная цена без НДС**
- **Товары в серии** - список артикулов, принадлежащих к той же серии, что и запрашиваемый артикул
- **Оптимизация наименование файлов**
- **Фильтр/чистка характеристик**
